...
<div class="col-md-12 align-content-center">
  ...
  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#cadastroCurso">Cadastrar Novo Curso</button>
  <div class="modal fade" id="cadastroCurso" tabindex="-1" aria-labelledby="cadastroCursoLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="labelNovoCurso">Novo Curso</h5>

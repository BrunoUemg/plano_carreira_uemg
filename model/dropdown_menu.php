<a href="" class="btn btn-primary ms-4 " data-bs-toggle="dropdown">Perfil</a>

<!-- Dropdown Menu -->

<div class="dropdown-menu">
    <label for="">Olá <?php echo $_SESSION['nome']; ?></label>
    <div class="dropdown-divider"></div>
    <?php if($_SESSION['professor'] == false){ ?>
    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#profileAluno" href="#">Alterar perfil</a>
    <?php }else{ ?>
    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#profileProfessor" id="openCadProf" href="#">Alterar perfil </a>
    <?php } ?>
    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#profileSenha" id="openCadProf" href="#">Alterar senha</a>
   
</div>
<!-- Dropdown Menu fim -->
<!-- Modal profile Professor inicio -->
<div class="modal fade" id="profileProfessor" tabindex="-1">
...
<!-- Modal profile Professor fim -->

<!-- Modal profile Aluno inicio -->
<div class="modal fade" id="profileAluno" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
